...
pub enum Event {
    /// An [`accesskit::ActionRequest`] event. When using an application these would be generated by the
    /// screen reader.
...
pub enum Key {
    ...
    F34,
    F35,
    // Don't always add keys last; add them to the group they best belong to.
}
